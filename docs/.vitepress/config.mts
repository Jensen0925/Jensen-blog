  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/vuejs/vitepress' },
      {
        ...
        link: 'https://raw.githubusercontent.com/Jensen0925/Jensen-blog/main/public/images/wechat-qrcode.jpg',
        ariaLabel: 'wechat'
      }
    ],
    // 底部版权部分
    ...
    //编辑本页
    editLink: {
      pattern: 'https://github.com/Jensen0925/Jensen-blog/edit/main/docs/:path',
      text: '在GitHub编辑本页'
    },
    //上次更新时间
    lastUpdated: {
